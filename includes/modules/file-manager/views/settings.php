...
<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="sitx-tab-form sitx-fm-settings">
	...
	<div class="sitx-settings-content-grid">
		<div class="sitx-settings-main">
			...
			<div class="sitx-setting-row si-form-row"><div><h3><?php esc_html_e( 'Store archives', 'siteintelix' ); ?></h3><p><?php esc_html_e( 'Permit approved archive uploads as files only. Archives are never extracted.', 'siteintelix' ); ?></p></div><label class="sitx-toggle"><input type="checkbox" name="settings[allow_archive_uploads]" value="1" <?php checked( ! empty( $siteintelix_fm_settings['allow_archive_uploads'] ) ); ?>><span class="sitx-toggle__slider"></span></label></div>
		...
		<aside class="sitx-settings-sidebar"><div class="sitx-side-card si-card"><h3><?php esc_html_e( 'Absolute protections', 'siteintelix' ); ?></h3><p><?php esc_html_e( 'WordPress core, wp-config.php, SiteIntelix, active plugins, the active theme, and must-use plugins cannot be modified.', 'siteintelix' ); ?></p></div><div class="sitx-side-card si-card"><h3><?php esc_html_e( 'WordPress controls', 'siteintelix' ); ?></h3><p><?php esc_html_e( 'DISALLOW_FILE_EDIT and DISALLOW_FILE_MODS are enforced for every request.', 'siteintelix' ); ?></p></div></aside>
	</div>
</form>
