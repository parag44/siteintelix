...
2. **Retired module cleanup** → remove legacy SiteIntelix Error UI state and owned drop-ins
...
3. Remove the retired `error_ui` module and migrate owned legacy files safely.
