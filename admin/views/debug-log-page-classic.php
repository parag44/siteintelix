...
<div class="wrap siteintelix-wrap si-admin-wrap" id="siteintelix-debug-log-page">
	...
	<div class="siteintelix-container">
		...
		<div class="siteintelix-debug-top-grid">
			...
			<!-- Mode Banner -->
			<div class="sitx-card sitx-card--interactive si-card siteintelix-debug-mode-card">
				...
				<a href="<?php echo esc_url( $siteintelix_settings_url ); ?>" class="sitx-btn sitx-btn--outline si-button si-button--secondary siteintelix-debug-mode-card__switch">
					<span class="dashicons dashicons-admin-generic"></span> <?php esc_html_e( 'Switch', 'siteintelix' ); ?>
				</a>
			</div>

			<!-- Quick Count -->
			<div class="sitx-card si-card siteintelix-debug-entries-card">
