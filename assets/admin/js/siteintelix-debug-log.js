		...
		function toggleDetails( button ) {
			...
			if ( nextState && list ) {
				cards.forEach( function ( otherCard ) {
					...
					otherDetails = otherCard.querySelector( '.sitx-log-card__details' );
					otherButtons = otherCard.querySelectorAll( '[data-sitx-toggle-details]' );
					otherLabel = otherCard.querySelector( '[data-sitx-toggle-label]' );
