...
if ( ! function_exists( 'siteintelix_render_module_card' ) ) {
	...
	function siteintelix_render_module_card( $module, $is_enabled ) {
		...
		?>
		<article class="sitx-module-card si-module-card si-card <?php echo $is_enabled ? 'is-active' : ''; ?>" data-siteintelix-module-card data-module-id="<?php echo esc_attr( $module_id ); ?>" data-module-title="<?php echo esc_attr( strtolower( (string) $module['title'] ) ); ?>" data-module-description="<?php echo esc_attr( strtolower( (string) $module['description'] ) ); ?>">
			<div class="sitx-module-card__top">
				...
				<span class="sitx-badge si-badge <?php echo $is_enabled ? 'sitx-badge--good si-badge--success' : 'sitx-badge--default si-badge--neutral'; ?>" data-siteintelix-module-status>
					<?php
					if ( $is_enabled ) {
			...
			<div class="sitx-module-card__footer">
				...
				$module_links   = array(
					...
					'plugin_version_switcher' => admin_url( 'admin.php?page=siteintelix-version-switcher' ),
