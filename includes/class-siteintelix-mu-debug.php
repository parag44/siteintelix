...
class SITEINTELIX_MU_Debug {
	...
	/**
	 * Remove the SiteIntelix MU plugin bootstrap file.
	 *
	 * @return true|WP_Error
	 */
...
// Define debug constants when capture is enabled (only if not yet defined).
...
// Early-define WP_DEBUG family so WordPress honours them from bootstrap.
