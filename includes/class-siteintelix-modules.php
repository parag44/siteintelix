...
class SITEINTELIX_Modules {
	...
	public static function get_all() {
		...
		$modules = array(
			...
			'plugin_version_switcher' => array(
				'id'          => 'plugin_version_switcher',
				'slug'        => 'plugin-version-switcher',
				'title'       => ( did_action( 'init' ) ? __( 'Plugin Version Switcher', 'siteintelix' ) : 'Plugin Version Switcher' ),
				'menu_title'  => ( did_action( 'init' ) ? __( 'Version Switcher', 'siteintelix' ) : 'Version Switcher' ),
				'description' => ( did_action( 'init' ) ? __( 'Store private plugin builds and safely switch the installed version while preserving activation state.', 'siteintelix' ) : 'Store private plugin builds and safely switch the installed version while preserving activation state.' ),
