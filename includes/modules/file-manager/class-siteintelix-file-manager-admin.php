		...
		wp_localize_script(
			...
			array(
				...
				'i18n'           => array(
					...
					'saving'           => __( 'Saving changes…', 'siteintelix' ),
					'saved'            => __( 'File saved successfully.', 'siteintelix' ),
					'saveFailed'       => __( 'The file could not be saved.', 'siteintelix' ),
					'fullScreen'       => __( 'Full screen', 'siteintelix' ),
					'exitFullScreen'   => __( 'Exit full screen', 'siteintelix' ),
					'uploaded'         => __( 'Upload complete.', 'siteintelix' ),
					'extracted'        => __( 'ZIP extraction complete.', 'siteintelix' ),
