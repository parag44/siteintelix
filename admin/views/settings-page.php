...
<div class="wrap siteintelix-wrap siteintelix-settings-wrap" id="siteintelix-settings-page">
	...
	<?php if ( isset( $_GET['siteintelix_settings_saved'] ) || isset( $_GET['siteintelix_settings_error'] ) || $siteintelix_external_dbg ) : // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>
		<div class="siteintelix-settings-alerts" aria-live="polite">
			<?php if ( isset( $_GET['siteintelix_settings_saved'] ) ) : // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>
				<div class="siteintelix-alert siteintelix-alert--success">
					<div class="siteintelix-alert__icon dashicons dashicons-yes-alt" aria-hidden="true"></div>
					<div class="siteintelix-alert__content">
						<h3 class="siteintelix-alert__title"><?php esc_html_e( 'Settings saved successfully.', 'siteintelix' ); ?></h3>
						<p class="siteintelix-alert__text"><?php esc_html_e( 'Your debug configuration has been updated.', 'siteintelix' ); ?></p>
					</div>
					<button type="button" class="siteintelix-alert__dismiss dashicons dashicons-no-alt" aria-label="<?php esc_attr_e( 'Dismiss message', 'siteintelix' ); ?>" data-siteintelix-dismiss></button>
				</div>
			<?php endif; ?>

			<?php if ( isset( $_GET['siteintelix_settings_error'] ) ) : // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>
				<div class="siteintelix-alert siteintelix-alert--error">
					<div class="siteintelix-alert__icon dashicons dashicons-warning" aria-hidden="true"></div>
					<div class="siteintelix-alert__content">
						<h3 class="siteintelix-alert__title"><?php esc_html_e( 'Could not save debug settings.', 'siteintelix' ); ?></h3>
						<p class="siteintelix-alert__text"><?php echo esc_html( urldecode( sanitize_text_field( wp_unslash( $_GET['siteintelix_settings_error'] ) ) ) ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?></p>
					</div>
					<button type="button" class="siteintelix-alert__dismiss dashicons dashicons-no-alt" aria-label="<?php esc_attr_e( 'Dismiss message', 'siteintelix' ); ?>" data-siteintelix-dismiss></button>
				</div>
			<?php endif; ?>
			...
			<?php if ( $siteintelix_external_dbg ) : ?>
				<div class="siteintelix-alert siteintelix-alert--warning">
					<div class="siteintelix-alert__icon dashicons dashicons-warning" aria-hidden="true"></div>
					<div class="siteintelix-alert__content">
						<h3 class="siteintelix-alert__title"><?php esc_html_e( 'Debug Conflict Detected', 'siteintelix' ); ?></h3>
						<p class="siteintelix-alert__text"><?php esc_html_e( 'WP_DEBUG is defined in wp-config.php outside of SiteIntelix control. This may override your selected method and cause unexpected behavior.', 'siteintelix' ); ?></p>
					</div>
					<button type="button" class="siteintelix-alert__dismiss dashicons dashicons-no-alt" aria-label="<?php esc_attr_e( 'Dismiss message', 'siteintelix' ); ?>" data-siteintelix-dismiss></button>
				</div>
			<?php endif; ?>
