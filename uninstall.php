 ...
 * Cleans up options and verified SiteIntelix MU-plugin files. SiteIntelix does
 * not modify wp-config.php during uninstall; turn Debug mode off first.
 *
 * @package SiteIntelix
 * @since   2.1.0
 */
...
$siteintelix_options = array(
	...
	'siteintelix_wp_config_debug_managed',
