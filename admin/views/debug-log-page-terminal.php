<?php
/**
 * Terminal Dark Debug Log Viewer page for SiteIntelix.
 *
 * Shows the latest 100 parsed entries without pagination.
 *
 * @package SiteIntelix
 * @since   2.5
 */
...
$siteintelix_log_data      = SITEINTELIX_Debug_Log::get_data( 100 );
...
?>
<div class="wrap siteintelix-wrap siteintelix-debug-ui sitx-terminal-ui" id="siteintelix-debug-log-page">
		...
		<div class="siteintelix-header__content">
			<div class="siteintelix-header__title-group">
				...
				<div class="siteintelix-header__text">
					...
					<p class="siteintelix-header__desc"><?php esc_html_e( 'Terminal dark stream showing the latest 100 log entries.', 'siteintelix' ); ?></p>
				</div>
			</div>
	...
	<div class="sitx-debug-modern-body">
		<section class="sitx-terminal-status" aria-label="<?php esc_attr_e( 'Debug log status', 'siteintelix' ); ?>">
			<div>
			...
			<a class="sitx-debug-btn sitx-debug-btn--secondary" href="<?php echo esc_url( $siteintelix_settings_url ); ?>">
				<span class="dashicons dashicons-admin-generic" aria-hidden="true"></span><?php esc_html_e( 'Switch Mode', 'siteintelix' ); ?>
			</a>
		</section>

		<section class="sitx-terminal-shell" aria-label="<?php esc_attr_e( 'Terminal dark debug log', 'siteintelix' ); ?>">
			<div class="sitx-terminal-titlebar">
				...
				<span><?php echo esc_html( sprintf( __( 'Latest %d entries', 'siteintelix' ), count( $siteintelix_entries ) ) ); ?></span>
			</div>
