		...
		<div class="sitx-card" style="padding: 12px; margin-bottom: 12px;">
			<div style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:16px;">
				<div style="display:flex; gap:8px; flex-wrap:wrap;">
					<a class="sitx-btn sitx-btn--white sitx-btn--sm sitx-filter siteintelix-debug-filter <?php echo 'all' === $siteintelix_active_level ? 'is-active' : ''; ?>" href="<?php echo esc_url( $siteintelix_filter_url( 'all' ) ); ?>" data-level="all"><?php esc_html_e( 'All Levels', 'siteintelix' ); ?> <span class="siteintelix-filter-count"><?php echo esc_html( number_format_i18n( count( $siteintelix_all_entries ) ) ); ?></span></a>
					<a class="sitx-btn sitx-btn--white sitx-btn--sm sitx-filter siteintelix-debug-filter <?php echo 'fatal' === $siteintelix_active_level ? 'is-active' : ''; ?>" href="<?php echo esc_url( $siteintelix_filter_url( 'fatal' ) ); ?>" data-level="fatal"><?php esc_html_e( 'Fatal', 'siteintelix' ); ?> <span class="siteintelix-filter-count"><?php echo esc_html( number_format_i18n( isset( $siteintelix_log_counts['FATAL'] ) ? (int) $siteintelix_log_counts['FATAL'] : 0 ) ); ?></span></a>
					<a class="sitx-btn sitx-btn--white sitx-btn--sm sitx-filter siteintelix-debug-filter <?php echo 'warning' === $siteintelix_active_level ? 'is-active' : ''; ?>" href="<?php echo esc_url( $siteintelix_filter_url( 'warning' ) ); ?>" data-level="warning"><?php esc_html_e( 'Warning', 'siteintelix' ); ?> <span class="siteintelix-filter-count"><?php echo esc_html( number_format_i18n( isset( $siteintelix_log_counts['WARNING'] ) ? (int) $siteintelix_log_counts['WARNING'] : 0 ) ); ?></span></a>
					<a class="sitx-btn sitx-btn--white sitx-btn--sm sitx-filter siteintelix-debug-filter <?php echo 'notice' === $siteintelix_active_level ? 'is-active' : ''; ?>" href="<?php echo esc_url( $siteintelix_filter_url( 'notice' ) ); ?>" data-level="notice"><?php esc_html_e( 'Notice', 'siteintelix' ); ?> <span class="siteintelix-filter-count"><?php echo esc_html( number_format_i18n( isset( $siteintelix_log_counts['NOTICE'] ) ? (int) $siteintelix_log_counts['NOTICE'] : 0 ) ); ?></span></a>
					<a class="sitx-btn sitx-btn--white sitx-btn--sm sitx-filter siteintelix-debug-filter <?php echo 'deprecated' === $siteintelix_active_level ? 'is-active' : ''; ?>" href="<?php echo esc_url( $siteintelix_filter_url( 'deprecated' ) ); ?>" data-level="deprecated"><?php esc_html_e( 'Deprecated', 'siteintelix' ); ?> <span class="siteintelix-filter-count"><?php echo esc_html( number_format_i18n( isset( $siteintelix_log_counts['DEPRECATED'] ) ? (int) $siteintelix_log_counts['DEPRECATED'] : 0 ) ); ?></span></a>
					<a class="sitx-btn sitx-btn--white sitx-btn--sm sitx-filter siteintelix-debug-filter <?php echo 'database' === $siteintelix_active_level ? 'is-active' : ''; ?>" href="<?php echo esc_url( $siteintelix_filter_url( 'database' ) ); ?>" data-level="database"><?php esc_html_e( 'Database', 'siteintelix' ); ?> <span class="siteintelix-filter-count"><?php echo esc_html( number_format_i18n( isset( $siteintelix_log_counts['DATABASE'] ) ? (int) $siteintelix_log_counts['DATABASE'] : 0 ) ); ?></span></a>
					<a class="sitx-btn sitx-btn--white sitx-btn--sm sitx-filter siteintelix-debug-filter <?php echo 'info' === $siteintelix_active_level ? 'is-active' : ''; ?>" href="<?php echo esc_url( $siteintelix_filter_url( 'info' ) ); ?>" data-level="info"><?php esc_html_e( 'Info', 'siteintelix' ); ?> <span class="siteintelix-filter-count"><?php echo esc_html( number_format_i18n( isset( $siteintelix_log_counts['INFO'] ) ? (int) $siteintelix_log_counts['INFO'] : 0 ) ); ?></span></a>
				</div>
				<form method="get" action="<?php echo esc_url( admin_url( 'admin.php' ) ); ?>" style="flex:1; max-width:400px; position:relative; margin:0;">
					...
					<p class="sitx-alert__msg">
						...
						if ( ! $siteintelix_log_has_file ) {
							...
							printf(
								...
								esc_html__( 'No log entries matched "%s".', 'siteintelix' ),
								esc_html( $siteintelix_search_query )
							);
						} elseif ( 'all' !== $siteintelix_active_level ) {
							esc_html_e( 'No entries match the selected level.', 'siteintelix' );
						} else {
