...
<div class="sitx-fm-toolbar si-toolbar">
	...
	<div class="sitx-fm-toolbar__group">
		...
		<button type="button" class="si-button si-button--secondary" data-fm-toggle-tree aria-expanded="true"><span class="sitx-fm-toolbar__icon dashicons dashicons-category" aria-hidden="true"></span><span><?php esc_html_e( 'Folders', 'siteintelix' ); ?></span></button>
		<button type="button" class="si-button si-button--secondary" data-fm-toggle-details aria-expanded="true"><span class="sitx-fm-toolbar__icon dashicons dashicons-info-outline" aria-hidden="true"></span><span><?php esc_html_e( 'Details', 'siteintelix' ); ?></span></button>
	</div>
