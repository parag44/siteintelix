...
?>
<div class="wrap siteintelix-wrap si-admin-wrap siteintelix-debug-ui <?php echo $siteintelix_group_similar ? '' : 'is-ungrouped-view'; ?>" id="siteintelix-debug-log-page">
	<?php
	...
	<section class="sitx-debug-summary" aria-label="<?php esc_attr_e( 'Debug log summary', 'siteintelix' ); ?>">
		<?php foreach ( $siteintelix_summary_cards as $siteintelix_card ) : ?>
			<article class="sitx-summary-card si-card sitx-summary-card--<?php echo esc_attr( $siteintelix_card['key'] ); ?>">
				<div>
	...
	<section class="sitx-debug-status-grid sitx-debug-status-grid--single" aria-label="<?php esc_attr_e( 'Debug log status', 'siteintelix' ); ?>">
		<div class="sitx-status-card si-card">
			...
			<a class="sitx-debug-btn sitx-debug-btn--secondary si-button si-button--secondary" href="<?php echo esc_url( $siteintelix_settings_url ); ?>"><?php esc_html_e( 'Switch Mode', 'siteintelix' ); ?></a>
		</div>
	</section>
	...
	<section class="sitx-filter-panel si-toolbar" aria-label="<?php esc_attr_e( 'Debug log filters', 'siteintelix' ); ?>">
		...
		<div class="sitx-filter-panel__bottom" data-sitx-advanced-filters>
			...
			<button type="button" class="sitx-debug-btn sitx-debug-btn--secondary si-button si-button--secondary" id="siteintelix-saved-filters">
			...
			<div class="sitx-log-list" data-sitx-log-list>
				<?php foreach ( $siteintelix_page_groups as $siteintelix_index => $siteintelix_group ) : ?>
					...
					>
						<div class="sitx-log-card__summary">
							...
							<div class="sitx-log-card__actions">
								<button type="button" class="sitx-debug-btn sitx-debug-btn--secondary si-button si-button--secondary" data-sitx-toggle-details aria-expanded="false" aria-controls="<?php echo esc_attr( $siteintelix_group_id ); ?>">
					...
					<?php foreach ( $siteintelix_single_entries as $siteintelix_single_entry ) : ?>
						...
						?>
						<article class="sitx-log-card si-card sitx-single-log-card sitx-log-card--<?php echo esc_attr( $siteintelix_single_level ); ?>"
							data-log-card
							data-single-card
